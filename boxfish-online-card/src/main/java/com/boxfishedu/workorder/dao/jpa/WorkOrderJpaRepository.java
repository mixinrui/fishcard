...
public interface WorkOrderJpaRepository extends JpaRepository<WorkOrder, Long> {
    ...
    List<WorkOrder> findByIsFreezeAndIsCourseOverAndStatusLessThanAndStartTimeLessThan(Integer freezeFlag,Integer isCourseOver,Integer status,Date startTime);
