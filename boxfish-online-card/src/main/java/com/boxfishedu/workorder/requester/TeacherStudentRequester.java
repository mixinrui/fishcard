...
//                teacherType);
    ...
    public static void main(String[] args) {
        ...
        try {
            String url = "http://online-api.boxfish.cn/teacheradmin/course/schedule/teacher/course/cancel";

            FileInputStream fis = new FileInputStream("/Users/hucl/Documents/bofish/doc/ids.txt");
...
//                if(num>1) {
//                    arrs = line.split(",");
//                    Date startDate=DateUtil.String2DateBack(arrs[0]);
//                    LocalDateTime nowLocalDate = LocalDateTime.ofInstant(new Date().toInstant(), ZoneId.systemDefault());
//                    LocalDateTime tomorrowLocalDate=nowLocalDate.plusDays(1);
//                    Date tommorowDate=DateUtil.localDate2Date(tomorrowLocalDate);
//                    String simpleStr=DateUtil.date2SimpleString(DateUtil.date2SimpleDate(tommorowDate));
//                    String startStr=simpleStr+" 00:00:00";
//                    String endStr=simpleStr+" 23:59:59";
//                    Date beginDate=DateUtil.String2Date(startStr);
//                    Date endDate=DateUtil.String2Date(endStr);
//                    if(startDate.after(beginDate)&&startDate.before(endDate)){
//
//                    }
//                }
//                num++;
...
//                    arrs = line.split(",");
//                    Map map = Maps.newHashMap();
//                    map.put("day", DateUtil.date2SimpleDate(DateUtil.String2DateBack(arrs[0])).getTime());
//                    map.put("timeSlotId", Long.parseLong(arrs[1]));
//                    map.put("teacherId", Long.parseLong(arrs[2]));
//                    map.put("studentId", Long.parseLong(arrs[3]));
//                }
//                num++;
//            }
            br.close();
